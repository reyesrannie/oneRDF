...
const AllocationModal = () => {
  ...
  const open = useSelector((state) => state.modal.allocation);
  ...
  const [addAllocation, { isLoading: loadingAdd }] = useAddAllocationMutation();
  const [updateAllocation, { isLoading: loadingUpdate }] =
    useUpdateAllocationMutation();
  ...
  const submitHandler = async (submitData) => {
    const payload = {
      ...submitData,
      id: allocationData?.id || undefined,
    };
    ...
    try {
      const res =
        allocationData !== null
          ...
          : await addAllocation(payload).unwrap();
