...
const AccountType = () => {
  ...
  const { data, isLoading, isError, isFetching } = useAccountTypeQuery(params);
  ...
  const [arhiveAccountType, { isLoading: loadingArchive }] =
    useArchiveAccountTypeMutation();

  const [importAccountType, { isLoading: loadingImport }] =
    useImportAccountTypeMutation();
  ...
  const handleImport = async () => {
    ...
    try {
      const res = await importAccountType(mapped).unwrap();
      dispatch(resetModal());
