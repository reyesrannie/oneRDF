...
import AccountUnitModal from "../../../components/modal/AccountUnitModal";
...
const AccountUnit = () => {
  ...
  const [archiveAccountUnit, { isLoading: loadingArchive }] =
    useArchiveAccountUnitMutation();

  const [importAccountUnit, { isLoading: loadingImport }] =
    useImportAccountUnitMutation();

  const onClickHandler = async () => {
    try {
      await archiveAccountUnit(accountTypeData).unwrap();
      enqueueSnackbar(
  ...
  const handleImport = async () => {
    ...
    try {
      const res = await importAccountUnit(mapped).unwrap();
      dispatch(resetModal());
