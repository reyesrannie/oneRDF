      ...
      children: [
        {
          ...
          element: <Customer />,
          route: "/customer_listing/customer",
          permission: ["customer"],
        },
        {
          segment: "region",
        ...
        },
        {
          ...
          element: <Province />,
          route: "/customer_listing/province",
          permission: ["geo"],
        },
        {
          ...
          route: "/customer_listing/city_municipality",
          permission: ["geo"],
        },
        {
          ...
          route: "/customer_listing/sub_municipality",
          permission: ["geo"],
        },
        {
          segment: "barangay",
